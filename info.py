...
API_ID = int(environ['29780148'])
API_HASH = environ['664c8d9a95afb8cebd92c7a8e6d1ec48']
BOT_TOKEN = environ['8113878651:AAEER6DoZlhKsFCgWbQP0PEAeLUwrTuVV-E']
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002452951033').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
ADMINS.append(7254350117)
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://devamanhear:A78hmVr9@@devamanhear.6mlgb.mongodb.net/?retryWrites=true&w=majority&appName=devamanhear")
DATABASE_NAME = environ.get('DATABASE_NAME', "devamanhear")
